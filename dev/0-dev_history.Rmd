...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Fuel Frontal Utility : tout ce qui sera utile pour l'essence",
    Description = "Toutes les fonctions utiles pour les traitements essence.",
    `Authors@R` = c(
...
usethis::use_data(DonneesTest)
usethis::use_r("DonneesTest")
devtools::document()
...
usethis::use_git_remote(
  name = "origin",
  url = "https://github.com/Valexandre/FuelFrontalUtility.git",
  overwrite = TRUE
)
#puis 
